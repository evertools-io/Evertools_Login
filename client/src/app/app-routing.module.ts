...
import { LicenseEditComponent} from './pages/license-edit/license-edit.component';
...
const routes: Routes = [
    ...
    { path: 'licenses/:id',  loadChildren: './pages/license-edit/license-edit.module#LicenseEditModule' , canActivate: [AuthGuard] },
    { path: 'licenses',  loadChildren: './pages/license-list/license-list.module#LicenseListModule' , canActivate: [AuthGuard] },
