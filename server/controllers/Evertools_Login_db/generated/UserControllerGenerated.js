...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.delete(baseUrl + "/:id", authorize(["ADMIN"]), UserController.delete);
    router.get(baseUrl + "/:id", authorize(["ADMIN"]), UserController.get);
    router.get(baseUrl + "", authorize(["ADMIN"]), UserController.list);
    router.post(baseUrl + "/:id", authorize(["ADMIN"]), UserController.update);
  },
